...
def wer(ref, hyp, debug=False):
    ...
    return {'changes': numSub + numDel + numIns, 'corrects': numCor, 'substitutions': numSub, 'insertions': numIns,
            'deletions': numDel}
...
if __name__ == "__main__":
    ...
    print(normalize_text('Hình ảnh Xquang xương bàn tay trái tương đương tuổi xương trẻ trai ~ 13 tuổi.',
